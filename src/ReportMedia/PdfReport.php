...
namespace codicastudio\ReportGenerator\ReportMedia;

use codicastudio\ReportGenerator\ReportGenerator;
...
class PdfReport extends ReportGenerator
{
	public function make()
	{
		...
		if ($this->withoutManipulation) {
			$html = \View::make('report-generator::without-manipulation-pdf-template', compact('headers', 'columns', 'showTotalColumns', 'query', 'limit', 'groupByArr', 'orientation', 'showHeader', 'showMeta', 'applyFlush', 'showNumColumn'))->render();
		} else {
			$html = \View::make('report-generator::general-pdf-template', compact('headers', 'columns', 'editColumns', 'showTotalColumns', 'styles', 'query', 'limit', 'groupByArr', 'orientation', 'showHeader', 'showMeta', 'applyFlush', 'showNumColumn'))->render();
		}
